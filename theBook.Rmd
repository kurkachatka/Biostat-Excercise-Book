...
Stworz ramke danych z wektorow uzywajac funkcji `data.frame()`
...
Dostan sie do konrentych elementow ramki danych za pomoca `[,]`
...
Dostan sie do konkretnych wektorow w ramce danych za pomoca operatora `$`
...
Sprawdz klase ramki danych i konkretnych wektorow
...
Zmien klasy zmiennych w ramce danych
